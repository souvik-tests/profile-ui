...
public class WebActivity extends AppCompatActivity {
	...
	private LinearLayout verifytick;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		secure = (LinearLayout) findViewById(R.id.secure);
		textview1 = (TextView) findViewById(R.id.textview1);
		verifytick = (LinearLayout) findViewById(R.id.verifytick);
		...
		webview1.setWebViewClient(new WebViewClient() {
			...
			public void onPageStarted(WebView _param1, String _param2, Bitmap _param3) {
				...
				_timer.scheduleAtFixedRate(timer1, (int)(50), (int)(50));
		...
		verifytick.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				_web_verify();
			}
	...
	private void initializeLogic() {
		...
		webview1.loadUrl("https://instagram.com/amisouvikpaul");
		progressbar1.setVisibility(View.VISIBLE);
	}
	...
	private void _web_verify () {
		final com.google.android.material.bottomsheet.BottomSheetDialog dialog = new com.google.android.material.bottomsheet.BottomSheetDialog(WebActivity.this); View lay = getLayoutInflater().inflate(R.layout.webverification, null); dialog.setContentView(lay);
